...
const modifications = [
    {
        file: './seed-repo-patched/scanner.js',
    ...
    {
        file: './seed-repo-patched/reachability.js',
        find: "fs.writeFileSync('run_state.json', JSON.stringify(runState, null, 2));",
        replace: `runState.timestamps = runState.timestamps || {};
...
fs.writeFileSync('../run_state.json', JSON.stringify(runState, null, 2));`,
    ...
    {
        file: './seed-repo-patched/patch-generator.js',
        find: "fs.writeFileSync('run_state.json', JSON.stringify(runState, null, 2));",
        replace: `runState.timestamps = runState.timestamps || {};
...
fs.writeFileSync('../run_state.json', JSON.stringify(runState, null, 2));`,
    ...
    {
        file: './exploit-verifier.js',
        find: "fs.writeFileSync('run_state.json', JSON.stringify(runState, null, 2));",
        replace: `runState.timestamps = runState.timestamps || {};
runState.timestamps.verified_at = new Date().toISOString();
fs.writeFileSync('run_state.json', JSON.stringify(runState, null, 2));`
    },
    {
        file: './compat-checker.js',
        find: "fs.writeFileSync('run_state.json', JSON.stringify(runState, null, 2));",
        replace: `runState.timestamps = runState.timestamps || {};
